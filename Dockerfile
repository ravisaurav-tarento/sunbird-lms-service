...
CMD java -XX:+PrintFlagsFinal $JAVA_OPTIONS -Djavax.net.ssl.trustStore=/opt/java/openjdk/lib/security/trustStoreFile -Djavax.net.ssl.trustStorePassword=changeit -Dplay.server.http.idleTimeout=180s -Dlog4j2.formatMsgNoLookups=true -cp '/home/sunbird/learner/learning-service-1.0-SNAPSHOT/lib/*' play.core.server.ProdServerStart  /home/sunbird/learner/learning-service-1.0-SNAPSHOT
